...
counts_dir = data_dir + "counts_humanOvarian_preprocessed.csv"
coords_dir = data_dir + "coords_humanOvarian_preprocessed.csv"
...
df_dir = base_dir + "outputs/results/SMASH_results_humanOvarian.csv"
