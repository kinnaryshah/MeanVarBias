...
file_list <- c(here("outputs", "simulations", "reps_968_50_50per_1000_0.2_to_3_0.5_to_9", "spe_nnSVG_1.rds"))
...
ggsave(here("plots", "supplementary", "simulation_motivation.png"),
