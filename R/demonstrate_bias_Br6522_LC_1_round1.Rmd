...
spe_Br6522_LC_1_round1 <- filter_genes(spe_Br6522_LC_1_round1) ##https://github.com/lmweber/nnSVG/issues/7 keep getting error that c++ error: dpotrf failed 
...
saveRDS(spe_Br6522_LC_1_round1, file = "spe_Br6522_LC_1_round1_nnSVG.rds")
...
# Restore the object
res_list <- list(
  humanDLPFC_nnSVG = rowData(readRDS(file = "spe_Br6522_LC_1_round1_nnSVG.rds")))
