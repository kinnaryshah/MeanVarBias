...
spe_weighted <- readRDS("reps_high_range_sigma.sq_high_beta_1000_genes_SVG_percentages_subset/70_percent_nonSVGs/spe_weighted_nnSVG_6.rds")
spe_unweighted <- readRDS("reps_high_range_sigma.sq_high_beta_1000_genes_SVG_percentages_subset/70_percent_nonSVGs/spe_nnSVG_6.rds")
...
length(tn_unweighted_not_weighted) # = 152
...
weights <- readRDS("reps_high_range_sigma.sq_high_beta_1000_genes_SVG_percentages_subset/70_percent_nonSVGs/weights_6.rds")
...
```{r}
# create some spot plots to visualize the differences 
# sample 20 genes that are getting captured by unwighted but not weighted
set.seed(1)
ixs <- sample(tn_unweighted_not_weighted, 20)
