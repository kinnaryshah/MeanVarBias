...
df_fxn <- function(file_name, dataset) {
  ...
  #keep only last 17 columns (nnSVG output) bc breast cancer dataset has different cols
  df_effect <- df_effect[,(ncol(df_effect)-17):ncol(df_effect)]
  
  #add col of dataset name
  df_effect$layer_val <- rep(dataset,1000)
  return(df_effect)
}
