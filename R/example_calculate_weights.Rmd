...
mu_hat <- t(as.data.frame((mat_brisc[,1])))
stopifnot(dim(mu_hat) == c(n, G))

s_g <- t(as.data.frame((mat_brisc[,2]))) |> 
...
saveRDS(w, file = "DLPFC_151507_BRISC_estimation.rds")

w <- readRDS(file = "mean_var_project/DLPFC_151507_BRISC_estimation.rds")
