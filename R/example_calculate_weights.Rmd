...
indices <- as.data.frame(objs_list[2]) < 0.01
low_s_g_indices <- as.vector(indices)

ix = which(low_s_g_indices)[3]
ix_name = rowData(spe_151507)$gene_name[ix]

df <- as.data.frame(cbind(spatialCoords(spe_151507), expr = counts(spe_151507)[ix, ]))
