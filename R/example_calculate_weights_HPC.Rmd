...
r <- t(as.matrix(counts(spe_V10B01_086_B1)))

n <- dim(spe_V10B01_086_B1)[2] # Number of Cells
G <- dim(spe_V10B01_086_B1)[1] # Number of Genes
...
coords <- spatialCoords(spe_V10B01_086_B1)
...
sum(lambda_hat < range(r_tilda)[1] | lambda_hat > range(r_tilda)[2]) / (dim(spe_V10B01_086_B1)[1]*dim(spe_V10B01_086_B1)[2]) 
sum(lambda_hat < range(r_tilda)[1]) / (dim(spe_V10B01_086_B1)[1]*dim(spe_V10B01_086_B1)[2])
sum(lambda_hat > range(r_tilda)[2]) / (dim(spe_V10B01_086_B1)[1]*dim(spe_V10B01_086_B1)[2])
...
saveRDS(w, file = "HPC_V10B01_086_B1_BRISC_estimation_spline.rds")

w <- readRDS(file = "mean_var_project/HPC_V10B01_086_B1_BRISC_estimation_spline.rds")
