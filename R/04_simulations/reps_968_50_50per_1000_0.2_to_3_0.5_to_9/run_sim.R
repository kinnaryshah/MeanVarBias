...
# create `/outputs/simulations/sim_dir` folder
if(!file.exists(here("outputs", "simulations", sim_dir))){
  dir.create(here("outputs", "simulations", sim_dir))
}
...
file = here("outputs", "simulations", sim_dir, paste0("spe_nnSVG_",K,".rds"))
saveRDS(spe, file = file)
...
file = here("outputs", "simulations", sim_dir, paste0("weights_",K,".rds"))
saveRDS(weights, file = file)

file = here("outputs", "simulations", sim_dir, paste0("spe_weighted_nnSVG_",K,".rds"))
saveRDS(spe, file = file)
