...
generate_noise_weights <- function(input, spatial_coords = NULL,
                             assay_name = "counts",
                             stabilize = TRUE,
...
weights <- generate_noise_weights(input = spe,
                            stabilize = TRUE,
...
file = here("outputs", "simulations", sim_dir, paste0("noise_weights_",K,".rds"))
saveRDS(weights, file = file)

file = here("outputs", "simulations", sim_dir, paste0("spe_noise_weighted_nnSVG_",K,".rds"))
